...
/** \file      Aic31.c
 *
 *  \brief     Implementation of the IOM for the AIC31 audio codec. This file allows you to select the
 *  overall codec configuration. You can configure things like CODEC in master mode or slave mode, Datatype,
 *  Bust type,etc. Please read the data sheet of the CODEC for the available options.
 *
...
/*-------Below you can configure the options available and pass this struct while creating a channel------------*/
/* -------- constants -------- */
