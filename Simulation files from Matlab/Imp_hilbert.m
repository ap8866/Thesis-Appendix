...
ATx = 1;                % Amplitude of Tx Signal, digital value
ARx = 1.5*ATx;         % Amplitude of Rx Signal, digital value
...
% dotItx = Sref_sin.*Stx; % dot product of Tx signal with I component of reference signal
% dotQtx = Sref_cos.*Stx; % dot product of Tx signal with Q component of reference signal


% ---- muiltiplication with reference signal ----
dotIrx = Srx.*Sref_sin; % dot product of Tx signal with I component of reference signal
dotQrx = Srx.*Sref_cos; % dot product of Tx signal with Q component of reference signal
...
% ATxdemod = sqrt((Itx^2)+(Qtx^2)); % calculated amplitude of Tx signal
ARxdemod = sqrt((Irx^2)+(Qrx^2)); % calculated amplitude of Rx signal
...
hold on 
grid on
plot(t,Sref_cos,'r','LineWidth',1.5)
plot(t,Sref_sin,'k','LineWidth',1.5)
l = legend('Modulated signal','Reference cosine','Hilbert transform of Reference cosine');
l.FontSize = 15;
